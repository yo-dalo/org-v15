  ...
  return (
    ...
    <div className="max-w-screen-lg py-10 px-4 sm:px-6 text-white sm:flex justify-between mx-auto">
        ...
        <div className="p-5 sm:w-2/12 border-r">
            <div className="text-sm uppercase tx_color_1 font-bold">Menu</div>
            <ul>
                <li className="my-2">
                    <a className="hover:tx_color_1" href="#">Home</a>
                </li>
                <li className="my-2">
                    <a className="hover:tx_color_1" href="#">Services</a>
                </li>
                <li className="my-2">
                    <a className="hover:text-[#8A5C7D]" href="#">Products</a>
                </li>
                <li className="my-2">
                    <a className="hover:tx_color_1" href="#">Pricing</a>
                </li>
            </ul>
        </div>
        <div className="p-5 sm:w-7/12 border-r text-center">
            <h3 className="font-bold text-xl tx_color_1 mb-4">Componentity</h3>
        ...
        <div className="p-5 sm:w-3/12">
            <div className="text-sm uppercase tx_color_1 font-bold">Contact Us</div>
            <ul>
                <li className="my-2">
